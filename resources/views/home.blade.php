        ...
        <div class="row row-cols-1">
            <div class="overflow-hidden d-slider1 ">
                ...
                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                  <div class="card-body">
                     <div class="progress-widget">
                        <div id="circle-progress-01" class="text-center circle-progress-01 circle-progress circle-progress-primary" data-min-value="0" data-max-value="100000" data-value="{{$totalSales}}" data-type="percent">
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter tSales" data-tSales="{{$totalSales}}">₱{{ number_format($totalSales, 2) }}</h4>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                  <div class="card-body">
                     <div class="progress-widget">
                        <div id="circle-progress-02" class="text-center circle-progress-01 circle-progress circle-progress-info" data-min-value="0" data-max-value="100000" data-value="{{$totalProfit}}" data-type="percent">
                           <svg class="card-slie-arrow icon-24" width="24" viewBox="0 0 24 24">
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter">₱{{ number_format($totalProfit, 2)}}</h4>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                  <div class="card-body">
                     <div class="progress-widget">
                        <div id="circle-progress-03" class="text-center circle-progress-01 circle-progress circle-progress-primary" data-min-value="0" data-max-value="100000" data-value="{{$totalCost}}" data-type="percent">
                           <svg class="card-slie-arrow icon-24" width="24" viewBox="0 0 24 24">
                              <path fill="currentColor" d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                           </svg>
                        </div>
                        <div class="progress-detail">
                           ...
                           <h4 class="counter tCost" data-tCost="{{$totalCost}}">₱{{ number_format($totalCost, 2) }}</h4>
                        </div>
                     </div>
                  </div>
               </li>
                  ...
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter">₱{{ number_format($incomeToday, 2) }}</h4>
                        </div>
                     </div>
                  </div>
               </li>
                  ...
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter">{{ number_format($totalCustomers) }}</h4>
                        </div>
                     </div>
                  </div>
               </li>
   ...
   <div class="col-md-12 col-lg-8">
      <div class="row">
         <div class="col-md-12">
            ...
            <canvas id="salesChart" data-tSales="{{$totalSales}}" data-tCost="{{$totalCost}}" data-tprofit="{{$totalProfit}}"width="400" height="200"></canvas>
         </div>
            ...
            <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="900">
               <div class="pb-4 border-0 card-header">
                  <div class="p-4 border border-white rounded primary-gradient-card">
                     ...
                     <img src="../assets/images/logo/sample1.png" class="img-fluid"alt="">
                  </div>
               </div>
               <div class="card-body">
