                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                       <a href="{{route('customer.show',[$item->id])}}" class="btn btn-primary custEdit"id="cusEdit">
                                       ...
                                       <a href="#" data-deld = '{{$item->id}}' class="btn btn-danger custDel" id="custDelete">
...
@section ('script')
@vite(['resources/js/Customer/customerlist.js'])
@endsection